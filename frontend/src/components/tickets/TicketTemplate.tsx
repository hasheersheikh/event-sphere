...
const TicketTemplate = React.forwardRef<HTMLDivElement, TicketTemplateProps>(({ booking, ticket }, ref) => {
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none opacity-[0.03] rotate-[-30deg] flex flex-wrap gap-20 p-10 select-none">
        {Array.from({ length: 12 }).map((_, i) => (
          <span key={i} className="text-6xl font-black uppercase tracking-widest">
            Event Sphere Secure
          </span>
        ))}
      </div>
      ...
      <div className="relative z-10 border-4 border-slate-900 rounded-3xl p-8 flex gap-8">
        ...
        <div className="flex-1 space-y-6">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-3xl font-bold tracking-tight">OFFICIAL TICKET</h1>
          </div>

          <div className="space-y-4">
            <div>
              <p className="text-xs font-bold uppercase text-slate-400 tracking-widest mb-1">Event Name</p>
              <h2 className="text-2xl font-bold">{event.title}</h2>
            </div>

            <div className="grid grid-cols-2 gap-6">
              <div>
                <p className="text-xs font-bold uppercase text-slate-400 tracking-widest mb-1">Date & Time</p>
              ...
              <div>
                ...
                <div className="flex items-center gap-2 font-semibold">
                  ...
                  <span className="truncate">{event.location.venueName || 'Main Hall'}</span>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-6">
              <div>
                <p className="text-xs font-bold uppercase text-slate-400 tracking-widest mb-1">Ticket Holder</p>
                <div className="flex items-center gap-2 font-semibold">
              ...
              <div>
                <p className="text-xs font-bold uppercase text-slate-400 tracking-widest mb-1">Ticket Type</p>
                <div className="flex items-center gap-2 font-semibold">
                  <Badge variant="outline" className="text-lg px-3 py-1 font-bold border-2">
          ...
          <div className="pt-6 border-t border-slate-200">
            <div className="flex items-center gap-2 text-slate-500 text-sm">
              ...
              <span>This ticket is unique and valid for one-time admission only.</span>
            </div>
          </div>
        </div>
      ...
      <div className="mt-8 text-center text-[10px] text-slate-400 font-medium">
        Generated by Event Sphere • Validated via Cryptographic ID • Do not share this QR code
      </div>
    </div>
  );
});
