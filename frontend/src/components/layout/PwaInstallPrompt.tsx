        ...
        >
          <div className="bg-card/90 backdrop-blur-xl border border-primary/20 rounded-2xl p-5 shadow-2xl flex items-center gap-4">
            ...
            <div className="flex-1">
              <h4 className="font-bold text-sm">Install Event Sphere</h4>
              <p className="text-xs text-muted-foreground">Access tickets offline and scan faster</p>
            </div>

            <div className="flex flex-col gap-2">
              <Button size="sm" onClick={handleInstall} className="h-8 text-xs font-bold rounded-lg px-4">
                Install
              </Button>
              <button 
