...
const BoostMarketingPage = () => {
  ...
  return (
    <div className="bg-background min-h-screen">
      <Navbar />
      <div className="p-4 md:p-6 space-y-16 md:space-y-24 max-w-[1440px] mx-auto pb-24 pt-20">
        {/* Public Landing Header */}
        <section className="pt-12 pb-4 space-y-5 text-center">
            <motion.div
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8 px-4">
            {SHOWCASE_REELS.map((reelId, idx) => (
              <motion.div
                ...
                className="group flex flex-col w-full max-w-[400px] mx-auto rounded-3xl overflow-hidden border border-border/60 hover:border-border transition-all duration-300 hover:shadow-[0_0_40px_rgba(0,0,0,0.3)] bg-card"
              >
                {/* Instagram header bar */}
                <div className="flex items-center justify-between px-4 py-3 border-b border-border/40">
                  <div className="flex items-center gap-2.5">
                    <div className="h-7 w-7 rounded-lg flex items-center justify-center bg-gradient-to-tr from-yellow-400 via-pink-500 to-purple-600 shadow-sm">
                      <Instagram className="h-4 w-4 text-white" />
                    </div>
                    <span className="text-[10px] font-black uppercase tracking-widest text-muted-foreground">Instagram Reel</span>
                  </div>
                  <a
