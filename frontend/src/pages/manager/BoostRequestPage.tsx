...
const PLANS = [
  { id: "starter", name: "Spark", price: "₹3,999", color: "cyan", bgClass: "bg-cyan-500", textClass: "text-cyan-500", borderClass: "border-cyan-500", hoverClass: "hover:border-cyan-500/50" },
  { id: "velocity", name: "Catalyst", price: "₹9,999", color: "pink", bgClass: "bg-neon-pink", textClass: "text-neon-pink", borderClass: "border-neon-pink", hoverClass: "hover:border-neon-pink/50" },
  { id: "elite", name: "Impact", price: "₹14,999", color: "orange", bgClass: "bg-orange-500", textClass: "text-orange-500", borderClass: "border-orange-500", hoverClass: "hover:border-orange-500/50" }
];
