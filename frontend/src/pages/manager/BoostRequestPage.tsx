...
const BoostRequestPage = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      <Navbar />
      <div className="p-4 md:p-8 flex flex-col items-center justify-center pt-32 pb-20">
        <motion.div 
            ...
            <div className="relative z-10 space-y-8">
              <div className="space-y-2">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <h2 className="text-3xl font-black brand-font uppercase tracking-tighter italic leading-none text-foreground">Initialize Engine.</h2>
                </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-8">
                  ...
                  <div className="space-y-3">
                    ...
                    >
                      <SelectTrigger className="bg-muted/50 border-border rounded-xl h-14 text-[11px] font-black uppercase tracking-widest focus:ring-primary italic">
                        <SelectValue placeholder={events.length > 0 ? "CHOOSE AN EVENT" : "ENTER EVENT TITLE BELOW"} />
                      </SelectTrigger>
                      <SelectContent className="bg-card border-border">
                        ...
                        {events.length === 0 && (
                          <div className="p-4 text-[10px] font-black text-center text-muted-foreground uppercase italic">Log in to select from your events.</div>
                        )}
                      </SelectContent>
                    </Select>
                  </div>
                ...
                <div className="space-y-3">
                  <label className="text-[10px] font-black uppercase tracking-widest text-muted-foreground ml-1">Additional Message / Event Title</label>
                  <Textarea 
                    placeholder="ENTER EVENT TITLE (IF NOT LISTED) OR SPECIFIC REQUIREMENTS..." 
