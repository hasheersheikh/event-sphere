...
const ContactPage = () => {
  ...
  const contactInfo = [
    { icon: Mail, label: "Email Support", value: "support@eventsphere.com" },
    { icon: Phone, label: "Call Us", value: "+91 1800-EVENT-SPHERE" },
    { icon: MapPin, label: "Office", value: "Cyber Hub, Gurugram, India 122002" },
  ];
              ...
              <div className="rounded-3xl border overflow-hidden h-64 bg-muted relative group">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                   <div className="text-center">
                     ...
                     <span className="font-semibold">Event Sphere HQ</span>
                   </div>
                </div>
...
const SelectBox = ({ id }: { id: string }) => (
  <select id={id} className="w-full h-12 rounded-xl border border-input bg-background px-3 py-2 text-sm ring-offset-background focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2">
