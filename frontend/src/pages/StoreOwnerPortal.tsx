...
const StoreOwnerPortal = () => {
  ...
  useEffect(() => {
    if (!owner) navigate("/store-owner/login");
  }, []);
  ...
  const { data: orders, isLoading } = useQuery({
    ...
    queryFn: async () => {
      ...
      const { data } = await api.get(`/store-orders/owner${params}`, {
  ...
  return (
    <div className="min-h-screen bg-muted/30 flex flex-col">
        ...
        <div className="container max-w-5xl flex items-center justify-between h-16 px-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[10px] text-muted-foreground font-bold uppercase tracking-widest">Store Owner Portal</p>
            </div>
          </div>
          <div className="flex items-center gap-3">
      ...
      <main className="flex-1 container max-w-5xl py-8 px-4 space-y-6">
        {/* Stats */}
                    ...
                    <div className="grid md:grid-cols-2 gap-4">
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="space-y-1.5 text-sm">
                          ...
                          {order.notes && (
                            <p className="italic text-xs text-muted-foreground">Note: {order.notes}</p>
                          )}
                        </div>
                      </div>
