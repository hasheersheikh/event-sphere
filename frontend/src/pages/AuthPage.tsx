        ...
        >
          ...
          <div className="mt-6 flex flex-col items-center gap-4">
            ...
            <button
              ...
              className="w-full h-14 flex items-center justify-center gap-4 bg-muted/20 hover:bg-muted/40 border border-border hover:border-primary/40 rounded-xl transition-all duration-200 group disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {isGoogleLoading ? (
              ...
              <span className="text-[11px] font-black uppercase tracking-[0.25em] text-foreground group-hover:text-primary transition-colors">
                {isLogin ? "Sign in with Google" : "Sign up with Google"}
              </span>
            </button>
          </div>

          <p className="mt-8 text-center text-[11px] font-black uppercase tracking-[0.2em] text-muted-foreground">
