      ...
      <main className="flex-1">
        ...
        <section className="py-20 md:py-32 bg-primary/5 border-b">
          <div className="container text-center max-w-4xl mx-auto px-4">
            ...
            >
              Reimagining <span className="gradient-text">Event Management</span>
            </motion.h1>
            <motion.p 
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              Event Sphere is a premium platform designed to connect people through unforgettable experiences. From local meetups to global conferences, we provide the tools to make every event a success.
            </motion.p>
          </div>
        </section>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-muted-foreground text-lg mb-4">
                We believe that human connection is the foundation of progress. Our mission is to empower individuals and organizations to create spaces where these connections can flourish.
              </p>
              <p className="text-muted-foreground text-lg">
                By combining cutting-edge technology with intuitive design, we've built a platform that removes the friction from event planning and discovery.
              </p>
            </div>
        ...
        <section className="py-20 bg-muted/30">
          <div className="container max-w-6xl mx-auto px-4 text-center">
            <h2 className="text-3xl font-bold mb-12">Built on Strong Foundations</h2>
            <div className="grid md:grid-cols-3 gap-8 text-left">
              {[
                ...
                <div key={i} className="p-8 bg-card rounded-2xl border border-primary/5">
        ...
        <section className="py-20 container text-center">
          <div className="bg-primary/5 rounded-3xl p-12 md:p-20 border border-primary/10 max-w-5xl mx-auto">
            ...
            <p className="text-muted-foreground text-lg mb-10 max-w-2xl mx-auto">
              Join thousands of organizers and attendees who are already using Event Sphere to create and discover amazing events.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link to="/auth">
                <Button size="lg" className="px-8 h-12 text-lg rounded-xl shadow-button">
                  Get Started for Free
                </Button>
              </Link>
              <Link to="/events">
                <Button variant="outline" size="lg" className="px-8 h-12 text-lg rounded-xl">
                  Browse Events
                </Button>
              </Link>
            </div>
